        ...
        for y in 0..CHUNK_SIZE.y {
            ...
            let tile_entity = commands
                .spawn(TileBundle {
                    ...
                    texture_index: TileTextureIndex(random_number),
                    ..Default::default()
                })
                .id();
...
fn spawn_chunks_around_camera(
    ...
    for transform in camera_query.iter() {
        ...
        for y in (camera_chunk_pos.y - POS_NUM)..(camera_chunk_pos.y + POS_NUM) {
            for x in (camera_chunk_pos.x - POS_NUM)..(camera_chunk_pos.x + POS_NUM) {
